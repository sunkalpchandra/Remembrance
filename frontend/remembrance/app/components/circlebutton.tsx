...
export default function CircleButton(props : CircleButtonProps) {
    ...
    return <div className = "relative border-[#dedddb] rounded-full flex items-center p-1 border-1 shadow-black shadow-2xs cursor-pointer hover:bg-[#DEDEDE] aspect-square" onClick = {props.onClick}
    onMouseLeave = {() => {
        setHover(false);
    }}
     onMouseEnter = {() => {
