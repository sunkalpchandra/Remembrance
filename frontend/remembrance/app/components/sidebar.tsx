...
export default function SideBar(props: SidebarProps) {
    ...
    return <div className=" h-screen w-[15%] bg-[#f0eeec] flex flex-col justify-between border-r-1 border-[#9a9a98] py-5 left-0 top-0">
        <div className=" w-full flex flex-col">
            ...
            <div className="flex flex-col items-center  text-black text-sm pt-10 ">
        ...
        <div className = "flex flex-col">
            ...
            <div className = "border-t-1 border-[#d9d9d9] flex flex-row justify-between px-2 items-center">
