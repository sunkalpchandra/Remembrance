...
import { PopoverTrigger, Popover, PopoverContent } from "@/app/components/novel/ui/popover";
...
export const ColorSelector = ({ open, onOpenChange }: {open: boolean, onOpenChange: any}) => {
